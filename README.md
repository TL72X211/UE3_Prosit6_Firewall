...
* NGFW : New Generation FireWall (souvent un contrôle au niveau applicatif)
* SI : Système d'information, ensemble organisé de ressources qui permet de collecter, stocker, traiter et distribuer des informations
...
* Appliance
* IP table : Interface en ligne de commande permettant de configurer Netfilter sur Linux
* Kerio : Entreprise spécialisée dans la protection des échanges (messagerie, pare-feu et telephone)
* Check point : Founisseur mondial de solution de sécurité des systèmes d'information
* Pfsense : Pare-Feu applicatif open source basé sur le systeme d'exploitation freeBSD, disponible via license apache
...
* Contrôle Applicatif (Deep Packet Inspection) ; Proxy
* VPN
* QoS (Quality of Service)
* Filtrage URL (ex : google.fr = interdit)
* Antivirus
* Antispam
